...
struct DriverApi {
    ...
    using DeviceGetAttribute = CUresult(CUDAAPI *)(
    ...
    using ModuleGetFunction = CUresult(CUDAAPI *)(
    ...
    using MemcpyHtoD = CUresult(CUDAAPI *)(
        CUdeviceptr, const void *, std::size_t);
    ...
    using StreamWaitEvent = CUresult(CUDAAPI *)(
        CUstream, CUevent, unsigned int);
    ...
    EventQuery event_query = nullptr;
    EventRecord event_record = nullptr;
    EventSynchronize event_synchronize = nullptr;
